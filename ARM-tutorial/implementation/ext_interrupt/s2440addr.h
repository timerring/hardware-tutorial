...
#define rNFCMD      (*(volatile char *)0x4e000008)            //NADD Flash command
#define rNFADDR     (*(volatile char *)0x4e00000c)            //NAND Flash address
#define rNFDATA     (*(volatile char *)0x4e000010)            //NAND Flash data
#define rNFDATA32   (*(volatile unsigned *)0x4e000010)            //NAND Flash data
#define rNFMECCD0   (*(volatile unsigned *)0x4e000014)            //NAND Flash data
#define rNFMECCD1   (*(volatile unsigned *)0x4e000018)            //NAND Flash data
#define rNFSECCD    (*(volatile unsigned *)0x4e00001c)            //NAND Flash data
#define rNFSTAT     (*(volatile unsigned *)0x4e000020)      //NAND Flash operation status
#define rNFESTAT0   (*(volatile unsigned *)0x4e000024)            //NAND Flash data
#define rNFESTAT1   (*(volatile unsigned *)0x4e000028)            //NAND Flash data
...
#define rNFSBLK     (*(volatile unsigned *)0x4e000038)            //NAND Flash data
#define rNFEBLK     (*(volatile unsigned *)0x4e00003c)            //NAND Flash data
...
#define rALMDAY    (*(volatile unsigned char *)0x57000063) //Alarm day
...
#define rBCDDAY    (*(volatile unsigned char *)0x5700007f) //BCD day
#define rBCDDATE   (*(volatile unsigned char *)0x57000083) //BCD date
...
#define rALMDAY    (*(volatile unsigned char *)0x57000060) //Alarm day
...
#define rBCDDAY    (*(volatile unsigned char *)0x5700007c) //BCD day
#define rBCDDATE   (*(volatile unsigned char *)0x57000080) //BCD date
